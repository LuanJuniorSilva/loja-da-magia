...
<?php if (count($result) > 0) : ?>
  ...
  <div class="main_search">
    <form action="?link=2" method="get">
      <input type="search" name="search" class="search_input" placeholder="Pesquise por E-mail ou Nome">
  ...
  <table class="table_main">
    ...
    <tbody>
      <?php foreach ($result as $list) : ?>
        <tr>
          ...
          <td>
            <a class="icone_see" href="<?php echo 'detail/' . $list->id ?>"><i class="fas fa-eye"></i></a>
            <a class="icone_see" href="<?php echo 'edit/' . $list->id ?>"><i class="fas fa-edit"></i></a>
          </td>
        </tr>
      <?php endforeach; ?>
    </tbody>
    <tfoot>
      <tr>
        <td colspan="5">E Conhecereis a verdade e a Verdade vos liverta-rá!</td>
      </tr>
    </tfoot>
  </table>
